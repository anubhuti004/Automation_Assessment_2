...
public class HomeLogin extends BasicActionIntegration {
    ...
    @Test(priority=2)       //for testing
    @Description("Creating HomePageImpl objects before class")
    public void initImpl() {
        System.out.println("Initialized");
        login_site = new HomePageImpl(bot);      //loginsite is a reference varibale pointing to homepageImpl object.
    }
...
//        login_site.enterUserName("standard_user");
//        login_site.enterPass("secret_sauce");
//        login_site.login();
    }
    ...
    public void product_page_ops() {
        ...
        pack_test = new PackageTest(this.bot);
        this.bot = pack_test.select_the_product();
    ...
    public void cart_page_ops() {
        System.out.println(bot.getCurrentUrl());
        cart_test = new CartTest(this.bot);
        this.bot = cart_test.verify_name_and_price();
        System.out.println(bot.getCurrentUrl());
    }
